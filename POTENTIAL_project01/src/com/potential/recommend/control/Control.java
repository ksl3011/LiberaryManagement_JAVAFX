...
public class Control implements Initializable {
	...
	public void add(){
		...
		String imagePath = "E:/JAVA/workspace_java/POTENTIAL_project01/data/java04/images/"+inputDate.getText()+".jpg";
	...
	public void showReview() {
		...
		//imageView 업데이트
		File coverImage = new File("E:/JAVA/workspace_java/POTENTIAL_project01/data/java04/images/"+recommend.getIndex()+".jpg");
		try {
			BufferedImage bi = ImageIO.read(coverImage);
			Image image = SwingFXUtils.toFXImage(bi, null);
			imageView.setImage(image);
		} catch (IOException e) {//해당 인덱스를 제목으로 하는 파일이 없을 경우 "표지 이미지가 없습니다" 파일 보여주기
			File noImage = new File("E:/JAVA/workspace_java/POTENTIAL_project01/data/java04/images/noImage.jpg");
			try {
